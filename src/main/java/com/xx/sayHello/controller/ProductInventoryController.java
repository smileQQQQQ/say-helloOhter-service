...
import com.xx.sayHello.request.ProductInventoryCacheRefreshRequest;
import com.xx.sayHello.request.ProductInventoryDBUpdateRequest;
import com.xx.sayHello.request.Request;
import com.xx.sayHello.request.TestUpdateDBLockRequest;
import com.xx.sayHello.service.ProductInventoryService;
import com.xx.sayHello.service.RequestAsyncProcessService;
import com.xx.sayHello.vo.Response;
...
public class ProductInventoryController {
	...
	@ResponseBody
	public Response testUpdateDBLock(@RequestBody ProductInventory productInventory) {
		System.out.println("===========日志===========: 接收到更新商品库存的请求，商品id=" + productInventory.getProductId() + ", 商品库存数量=" + productInventory.getInventoryCnt());
//		//获取锁
...
//	    	System.out.println("获取锁"+lock.getName() +",获取状态："+cacheRes);
			Request request = new TestUpdateDBLockRequest(
					productInventory, productInventoryService);
			requestAsyncProcessService.process(request);
			response = new Response(Response.SUCCESS);
		} catch (Exception e) {
